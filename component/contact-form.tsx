  ...
  const formContent = (
    <>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Row 6: Buttons */}
        <div className={`flex gap-4 pt-2 ${inline ? '' : 'pt-4'}`}>
          <button
            type="submit"
            disabled={isSubmitting}
            className="htp-cta flex-1 disabled:opacity-50 disabled:cursor-not-allowed flex flex-col items-center justify-center gap-0.5 py-3 sm:py-3.5"
          >
            {isSubmitting ? (
