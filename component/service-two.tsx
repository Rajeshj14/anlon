...
const CARDS = [
  {
    ...
    tagColor: "#9B7057",
    tagBg: "rgba(155,112,87,0.12)",
    tagBorder: "rgba(155,112,87,0.3)",
  ...
  },
  {
    ...
    tagColor: "#b8865a",
    tagBg: "rgba(184,134,90,0.12)",
    tagBorder: "rgba(184,134,90,0.35)",
  ...
  },
  {
    ...
    tagColor: "#c4906e",
    tagBg: "rgba(196,144,110,0.12)",
    tagBorder: "rgba(196,144,110,0.35)",
  ...
  },
  {
    ...
    tagColor: "#9B7057",
    tagBg: "rgba(155,112,87,0.12)",
    tagBorder: "rgba(155,112,87,0.35)",
  ...
  return (
    <>
      <style>{`
        ...
        .ba-eyebrow-line-l { height:1px; width:60px; background:linear-gradient(90deg,transparent,#9B7057); }
        .ba-eyebrow-line-r { height:1px; width:60px; background:linear-gradient(90deg,#9B7057,transparent); }
      ...
      <section className="ba-wrap max-sm:py-5 py-10" style={{ background: "#faf8f6" }}>
          ...
          <RevealOnScroll direction="up" duration={700}>
            <div className="ba-title-block text-center mb-16">
              <div className="flex items-center justify-center gap-4 max-sm:mb-3 mb-2">
                ...
                <span style={{ fontFamily:"Outfit,sans-serif", fontSize:"11px", fontWeight:600, letterSpacing:"3px", textTransform:"uppercase", color:"#9B7057" }}>
                  Our Treatment Menu
                </span>
                <div className="ba-eyebrow-line-r" />
              </div>
              <h2 style={{ fontSize:"clamp(32px,5vw,48px)", fontWeight:700, color:"#111111", lineHeight:1.2, margin:"0 0 4px", letterSpacing:"-0.3px" }}>
                5 Treatments. One Goal
              </h2>
              <h2 className="ba-italic-accent" style={{ fontSize:"clamp(32px,5vw,48px)", fontWeight:700, lineHeight:1.25, margin:"0 0 10px" }}>
              ...
              <p style={{ fontSize:"15px", color:"rgba(0,0,0,0.5)", maxWidth:"720px", margin:"0 auto", lineHeight:1.7, fontWeight:400 }}>
                Each treatment is performed under the direct supervision of our expert dermatologists — where medical precision meets aesthetic artistry.
              </p>
            </div>
          </RevealOnScroll>

          {/* ── Carousel ── */}
          <RevealOnScroll direction="up" duration={700} delay={180}>
            <div className="mb-4">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  style={{ background:"rgba(155,112,87,0.07)", border:"1px solid rgba(155,112,87,0.2)", color:"#9B7057", transition:"all 0.2s" }}
                  onMouseEnter={e => { e.currentTarget.style.background="rgba(155,112,87,0.15)"; e.currentTarget.style.borderColor="rgba(155,112,87,0.4)"; }}
                  onMouseLeave={e => { e.currentTarget.style.background="rgba(155,112,87,0.07)"; e.currentTarget.style.borderColor="rgba(155,112,87,0.2)"; }}
                >
                    ...
                    return (
                      <div
                        ...
                        style={isCenter ? {
                          ...
                          boxShadow: "0 0 40px rgba(155,112,87,0.12), 0 20px 50px rgba(0,0,0,0.12)",
                          zIndex: 2,
                        } : {
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6">
                          ...
                          >
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                              <path d="M9 11l3 3 9-9" stroke="#c4906e" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            {card.stat}
                          </div>
                        </div>
                ...
                {CARDS.map((_, i) => (
                  <button
                    ...
                    style={{
                      ...
                      background: i === current ? "#9B7057" : "rgba(155,112,87,0.2)",
                      boxShadow: i === current ? "0 0 10px rgba(155,112,87,0.4)" : "none",
                    }}
                  />
                ))}
              </div>
              ...
              <div className="ba-bottom-nav" style={{ display:"none", alignItems:"center", justifyContent:"center", gap:"12px", marginTop:"16px" }}>
                <button
                  ...
                  style={{ background:"rgba(155,112,87,0.07)", border:"1px solid rgba(155,112,87,0.2)", color:"#9B7057" }}
                >
